  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center min-h-[60vh] gap-5">
      <div className="relative flex items-center justify-center w-20 h-20">
        {/* Outer pulsing ring */}
        <div className="absolute inset-0 w-full h-full border-[3px] border-purple-100 rounded-full animate-pulse"></div>
        {/* Inner fast spinning ring */}
        <div className="absolute inset-0 w-full h-full border-[3px] border-purple-600 border-t-transparent border-l-transparent rounded-full animate-spin"></div>
        {/* Center Icon */}
        <Hexagon className="w-8 h-8 text-purple-600 relative z-10" />
      </div>
