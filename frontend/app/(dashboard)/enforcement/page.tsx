...
export default function EnforcementPage() {
  ...
  }, [allocationData, projectedData, officers, maxPerCell, nextMax, showSimulation, t]);
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto flex flex-col gap-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-gray-800 tracking-tight">{t.titles.enforcementShift}</h1>
