    ...
    <div className="flex flex-col md:flex-row gap-4 h-full">
      ...
      <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm flex-1">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="font-bold text-gray-800">{t.allocationControls.resourceAllocation}</h3>
            <p className="text-xs text-gray-500">{t.allocationControls.availableOfficers}</p>
          </div>
        </div>
        ...
        <div className="mb-6">
          <div className="flex justify-between items-end mb-2">
            ...
            <span className="text-sm font-medium text-gray-500 mb-1">{t.allocationControls.officersLabel}</span>
          </div>
          <input
            type="range"
            min="5"
        ...
        <div className="flex items-center justify-between text-sm mb-6">
          <span className="text-gray-600 font-medium">{t.allocationControls.maxPerZoneShift}</span>
          <select 
            value={maxPerCell}
          ...
          >
            <option value={1}>1 {t.allocationControls.officerSingular}</option>
            <option value={2}>2 {t.allocationControls.officersLabel}</option>
            <option value={3}>3 {t.allocationControls.officersLabel}</option>
            <option value={5}>5 {t.allocationControls.officersLabel}</option>
          </select>
        </div>
        ...
        >
          ...
          {t.allocationControls.downloadCsvRoster}
        </button>
      </div>
      ...
      <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm flex-1 flex flex-col relative overflow-hidden">
        ...
        <div className="flex justify-end mb-4">
          <div className="flex bg-gray-100 p-1 rounded-lg border border-gray-200">
            ...
            >
              {t.allocationControls.currentState}
            </button>
            <button 
            ...
            >
              ...
              {t.allocationControls.projectedImpact}
            </button>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col justify-center">
          <div className="flex justify-between items-start">
            <div>
              <h3 className="text-sm font-bold text-gray-800 mb-1">{t.allocationControls.priorityCovered}</h3>
            ...
            {showSimulation && (
              <div className="text-right bg-amber-50 p-3 rounded-lg border border-amber-100 animate-in fade-in zoom-in duration-300">
                <h3 className="text-xs font-bold text-amber-800 mb-1 flex items-center gap-1">
                  ...
                  {t.allocationControls.residualRisk}
                </h3>
          ...
          <div className="mt-4 space-y-2 text-xs">
            <div className="flex justify-between items-center text-gray-500 font-medium">
              <span>{t.allocationControls.uniformDeployment}</span>
            ...
            <div className="flex justify-between items-center text-emerald-600 font-bold bg-emerald-50 p-2 rounded-lg border border-emerald-100">
              <span className="flex items-center gap-1"><TrendingUp className="w-3 h-3" /> {showSimulation ? t.allocationControls.priorityDeterred : t.allocationControls.efficiencyGain}</span>
