      ...
      <div className="flex-1 overflow-auto p-4">
        <table className="w-full text-xs text-left">
          <thead className="sticky top-0 bg-white z-10">
            <tr>
              <th className="py-2 px-3 font-bold text-gray-500 border-b border-gray-100 w-1/3">Police Station</th>
              {shiftLabels.map((label, i) => (
                <th key={i} className="py-2 px-3 font-bold text-gray-500 border-b border-gray-100 text-center w-2/9">
                  {label.split(" ")[0]}
                </th>
              ))}
            </tr>
